...
class WP_Pro_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
     <div class="pro-box">
       <a href="<?php echo esc_url('http://webriti.com/corpbiz/');?>" target="_blank" class="upgrade" id="review_pro"><?php _e('Upgrade to pro','corpbiz' ); ?></a>
...
class WP_Review_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
	  <div class="pro-box">
     <a href="<?php echo esc_url('https://wordpress.org/support/view/theme-reviews/corpbiz#postform/');?>" target="_blank" class="review" id="review_pro"><?php _e( 'ADD YOUR REVIEW','corpbiz' ); ?></a>
	 </div>
    <?php
    }
}
...
class WP_document_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
      <div class="pro-box">
	 <a href="<?php echo esc_url('http://webriti.com/help/');?>" target="_blank" class="document" id="review_pro"><?php _e( 'DOCUMENTATION','corpbiz' ); ?></a>
